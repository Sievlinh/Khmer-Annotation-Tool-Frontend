  ...
  return (
    <div className="min-h-full bg-white p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        ...
        <div>
          <Card className={"bg-white rounded-xl shadow-md hover:shadow-lg transition duration-300 border-b-4 border-t-4 border-[#12284c]"}>
          ...
          <Card className="overflow-hidden bg-white rounded-xl shadow-md hover:shadow-lg transition duration-300 border-b-4 border-t-4 border-[#12284c]">
            <CardHeader className="pb-3 flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                ...
                <Button variant="outline" onClick={() => setExportOpen(true)} className={"bg-white text-black hover:text-white hover:bg-[#76bc21] "}>
